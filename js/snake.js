...
//TODO: Remove GOOD LUCK LISTENER
...
function endGame(score){
    ...
    /*var scoreLen = score.toString().split("");
    //console.log("score len: ", scoreLen[0])
    console.log("image link: ", getNum(scoreLen[0]));
    $(".scorePad").append(`<img src="${getNum(scoreLen[0])}">`);
    $(".scorePad").append(`<img src="${getNum(scoreLen[1])}">`); 
    console.log($('.scorePad'))*/

    /*function whatScore(score){
        $(".scorePad").empty();
        var scoreLen = score.toString().split("");
        //console.log(scoreLen)
        //$(".gamePad").innerHTML = '<img src="' + getNum(scoreLen[1]) + '" />' ;
        for(i = 0; i < scoreLen.length;i++){
            $(".scorePad").append(`<img src="${getNum(scoreLen[i])}">`);
            //$( '<img src="' + getNum(scoreLen[i]) + '" />' ).appendTo(".gamePad");
            //$('.gamePad').html('<img src="' + getNum(scoreLen[i]) + '" />')
            //console.log(getNum(scoreLen[i]));
            //console.log(i);
        }
    }*/
...
//RENDER JS
//console.log(document.getElementsByTagName( 'canvas' )) ---- 0 tetris
